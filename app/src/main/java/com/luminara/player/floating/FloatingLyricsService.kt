...
class FloatingLyricsService : Service() {
    ...
    private fun expandControls() {
        ...
        val controls = LinearLayout(this).apply {
            ...
            addView(button(android.R.drawable.ic_menu_preferences) {
                startActivity(Intent(this@FloatingLyricsService, com.luminara.player.MainActivity::class.java).addFlags(Intent.FLAG_ACTIVITY_NEW_TASK or Intent.FLAG_ACTIVITY_SINGLE_TOP))
            })
    ...
    private fun refresh() {
        ...
        root?.findViewById<TextView>(TITLE_ID)?.text = player.mediaMetadata.title?.toString() ?: "Luminara"
